...
<html lang="en">
	<head>
		...
		<script src="../ajax/resetPasswordAJAX.js" defer></script>
	...
	<body class="d-flex flex-column justify-content-between">
		...
		<div class="wrapper" >
			<h2><img draggable="false" src="../icons/dont_Trip.png" class="center"  width="300" height="80" alt="Don't Trip" rel="noopener" loading="lazy"/></img></h2>
		...
		<footer id="footer">
			<a href="../login" class="logo">
				<img draggable="false" src="../icons/dont_Trip.png" width="150" height="40" rel="noopener" alt="Don't Trip" loading="lazy"></img>
			</a>
